...
//   const userSerialize = (user, done) => {
//     done(null, user.id);
//   };

//   const userDeserialize = (id, done) => {
//     connection.query(`SELECT * FROM user WHERE id="${id}"`, (err, results) => {
//       if (err) {
//         console.log(err);
//         return;
...
//   const adminSerialize = (admin, done) => {
//     done(null, admin.id);
//   };

//   const adminDeserialize = (id, done) => {
...
//       if (results.length === 0) {
//         return done(null, false, {
//           message: "Oops! No admin with that id!",
//         });
//       }
...
//   passport.serializeUser(adminSerialize);
//   passport.deserializeUser(userDeserialize);
//   passport.deserializeUser(adminDeserialize);
// };
